...
import { ArchiveIcon, LockIcon } from "./icons";
  ...
  return (
    <li>
      <Link
        ...
        className="group flex flex-col gap-3 rounded-2xl border border-edge bg-panel/80 p-5 shadow-lg shadow-black/20 transition-colors hover:border-zinc-600 hover:bg-panel focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/30"
      >
        <div className="flex min-w-0 items-center gap-2.5">
          <span className="shrink-0 text-zinc-500 transition-colors group-hover:text-zinc-300">
            <ArchiveIcon className="h-4 w-4" />
          </span>
          <span className="truncate font-mono text-sm text-zinc-100">{room.roomId}</span>
          <span className="ml-auto flex shrink-0 items-center gap-1 rounded-full border border-edge bg-raised/60 px-2.5 py-1 text-[11px] text-zinc-400">
